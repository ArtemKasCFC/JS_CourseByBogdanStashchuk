...
function quantitiesByCategories(products) {
 return products.reduce((categories, cur) => 
  {
    let {category, quantity} = cur
...
// function quantitiesByCategories(products) {
//   return products.reduce((categories, cur) => 
//   cur.category === 'Accessories' ? (categories[cur.category] = (categories[cur.category] || 0) + cur.quantity, categories) :
//   cur.category === 'Phones' ? (categories[cur.category] = (categories[cur.category] || 0) + cur.quantity, categories) :
//   cur.category === 'Watches' ? (categories[cur.category] = (categories[cur.category] || 0) + cur.quantity, categories) : categories , {})
//  }
